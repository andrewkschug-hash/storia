  ...
  return (
    <AtmosphereBackground>
      <View
        ...
        {step === 'word' ? (
          <View style={styles.panel}>
            ...
            <Pressable
              ...
              <Text style={[Typography.reader, { color: colors.text }]}>
                Luca cerca una{' '}
        ...
        {step === 'sentence' ? (
          <View style={styles.panel}>
            <Text style={[Typography.heroTitle, { color: colors.text }]}>Tap a sentence</Text>
            <Text style={[Typography.body, { color: colors.textSecondary, marginTop: Spacing.md }]}>
            ...
            <Pressable
              ...
              style={[styles.sample, { backgroundColor: colors.backgroundElevated, borderColor: colors.border }]}>
              <Text style={[Typography.reader, { color: colors.text }]}>Luca cerca una casa.</Text>
            </Pressable>
          </View>
        ) : null}
        ...
        {step === 'recap' ? (
          <View style={styles.panel}>
            <Text style={[Typography.heroTitle, { color: colors.text }]}>When you finish reading</Text>
            <Text style={[Typography.body, { color: colors.textSecondary, marginTop: Spacing.md }]}>
        ...
        {step === 'done' ? (
          <View style={styles.panel}>
            <Text style={[Typography.heroTitle, { color: colors.text }]}>That&apos;s it</Text>
            <Text style={[Typography.body, { color: colors.textSecondary, marginTop: Spacing.md }]}>
