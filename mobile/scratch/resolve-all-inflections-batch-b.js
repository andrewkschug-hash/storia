...
const moreBase = [
  { lemmaId: 'dimostrazione', italian: 'dimostrazione', english: 'demonstration / display', partOfSpeech: 'noun', gender: 'feminine', difficulty: 2, frequency: 'high', introducedChapter: 65, inflections: ['dimostrazione', 'dimostrazioni'] },
  { lemmaId: 'disperatamente', italian: 'disperatamente', english: 'desperately', partOfSpeech: 'adverb', difficulty: 2, frequency: 'high', introducedChapter: 65, inflections: ['disperatamente'] },
  { lemmaId: 'segreto', italian: 'segreto', english: 'secret', partOfSpeech: 'noun', gender: 'masculine', difficulty: 1, frequency: 'high', introducedChapter: 65, inflections: ['segreto', 'segreti'] },
  { lemmaId: 'buonasera', italian: 'buonasera', english: 'good evening', partOfSpeech: 'interjection', difficulty: 1, frequency: 'high', introducedChapter: 65, inflections: ['buonasera'] },
  { lemmaId: 'colmo', italian: 'colmo', english: 'full / brimful / overflowing', partOfSpeech: 'adjective', difficulty: 2, frequency: 'high', introducedChapter: 65, inflections: ['colmo', 'colma', 'colmi', 'colme'] },
  { lemmaId: 'entusiasta', italian: 'entusiasta', english: 'enthusiastic', partOfSpeech: 'adjective', difficulty: 2, frequency: 'high', introducedChapter: 65, inflections: ['entusiasta', 'entusiasti', 'entusiaste'] },
  { lemmaId: 'comodamente', italian: 'comodamente', english: 'comfortably', partOfSpeech: 'adverb', difficulty: 2, frequency: 'high', introducedChapter: 65, inflections: ['comodamente'] },
  { lemmaId: 'boschetto', italian: 'Boschetto', english: 'Boschetto (street name)', partOfSpeech: 'noun', gender: 'masculine', difficulty: 1, frequency: 'medium', introducedChapter: 65, inflections: ['boschetto', 'Boschetto'] },
  { lemmaId: 'venezia', italian: 'Venezia', english: 'Venice', partOfSpeech: 'noun', gender: 'feminine', difficulty: 1, frequency: 'high', introducedChapter: 65, inflections: ['venezia', 'Venezia'] },
  { lemmaId: 'panisperna', italian: 'Panisperna', english: 'Panisperna (street name)', partOfSpeech: 'noun', gender: 'feminine', difficulty: 1, frequency: 'medium', introducedChapter: 63, inflections: ['panisperna', 'Panisperna'] },
  { lemmaId: 'pietralba', italian: 'Pietralba', english: 'Pietralba (Luca’s hometown)', partOfSpeech: 'noun', gender: 'feminine', difficulty: 1, frequency: 'medium', introducedChapter: 65, inflections: ['pietralba', 'Pietralba'] },
  { lemmaId: 'delizioso', italian: 'delizioso', english: 'delicious / delightful', partOfSpeech: 'adjective', difficulty: 1, frequency: 'high', introducedChapter: 64, inflections: ['delizioso', 'deliziosa', 'deliziosi', 'deliziose'] },
  { lemmaId: 'sgradevole', italian: 'sgradevole', english: 'unpleasant / disagreeable', partOfSpeech: 'adjective', difficulty: 2, frequency: 'high', introducedChapter: 64, inflections: ['sgradevole', 'sgradevoli'] },
  { lemmaId: 'plastica', italian: 'plastica', english: 'plastic', partOfSpeech: 'noun', gender: 'feminine', difficulty: 1, frequency: 'high', introducedChapter: 64, inflections: ['plastica'] },
  { lemmaId: 'preda', italian: 'preda', english: 'prey / in the grip of', partOfSpeech: 'noun', gender: 'feminine', difficulty: 2, frequency: 'medium', introducedChapter: 64, inflections: ['preda'] },
  { lemmaId: 'imbarazzato', italian: 'imbarazzato', english: 'embarrassed', partOfSpeech: 'adjective', difficulty: 2, frequency: 'high', introducedChapter: 64, inflections: ['imbarazzato', 'imbarazzata', 'imbarazzati', 'imbarazzate'] },
  { lemmaId: 'narrazione', italian: 'narrazione', english: 'narration / narrative', partOfSpeech: 'noun', gender: 'feminine', difficulty: 2, frequency: 'high', introducedChapter: 64, inflections: ['narrazione', 'narrazioni'] },
  { lemmaId: 'correggere', italian: 'correggere', english: 'to correct', partOfSpeech: 'verb', difficulty: 2, frequency: 'high', introducedChapter: 64, inflections: ['correggere', 'corregge', 'correggeva', 'corretto'] },
  { lemmaId: 'violenza', italian: 'violenza', english: 'violence / fury', partOfSpeech: 'noun', gender: 'feminine', difficulty: 2, frequency: 'high', introducedChapter: 63, inflections: ['violenza'] },
  { lemmaId: 'olivo', italian: 'olivo', english: 'olive wood / olive tree', partOfSpeech: 'noun', gender: 'masculine', difficulty: 1, frequency: 'high', introducedChapter: 64, inflections: ['olivo', 'olivi'] },
  { lemmaId: 'castelli', italian: 'Castelli', english: 'Castelli Romani (region near Rome)', partOfSpeech: 'noun', gender: 'masculine', difficulty: 1, frequency: 'medium', introducedChapter: 65, inflections: ['castelli', 'Castelli'] },
  { lemmaId: 'romano', italian: 'romano', english: 'Roman', partOfSpeech: 'adjective', difficulty: 1, frequency: 'high', introducedChapter: 65, inflections: ['romano', 'romana', 'romani', 'romane'] }
];

for (const entry of moreBase) {
...
for (const [k, v] of Object.entries(completeSurfaceMap)) {
